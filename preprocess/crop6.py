...
def crop(img, pleft=6, ptop=23.2, pright=6.8, pbottom=11, number=None):
	if number == 112:
		pleft, ptop, pright, pbottom = 5.1, 19.2, 5.3, 13.3
		img = img.rotate(-0.8)
...
def partion_image(img, ratio=1/43.0, n=5, number=None):
	images = []
	srt = 0
	width, height = img.size
	space = ratio*height
